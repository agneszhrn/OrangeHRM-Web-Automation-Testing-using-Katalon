...
WebUI.verifyTextPresent('Record Found', false)

// Validation 2 : Verify the Employee Name “Harry Potter” appears in the list
WebUI.verifyElementText(findTestObject('Object Repository/Page_OrangeHRM/PIM/Search/textonList_EmployeeLastName_Potter'), 'Harry')
WebUI.verifyElementText(findTestObject('Object Repository/Page_OrangeHRM/PIM/Search/textonList_EmployeeFirstName_Harry'), 'Potter')
