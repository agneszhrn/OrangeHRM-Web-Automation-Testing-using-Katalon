...
// Click dropdown Employee Status
WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/PIM/Search/dropdown_EmployeeStatus'))

// Select valid Employee Status
WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/PIM/Search/option_EmploymentStatus_FullTimePermanent'))
...
// Validation 2 : Verify the Employee Status “Full-Time Permanent” appears in the list
WebUI.verifyElementText(findTestObject('Object Repository/Page_OrangeHRM/PIM/Search/textonList_EmployeeStatus_Full-TimePermanent'), 'Full-Time Permanent')
